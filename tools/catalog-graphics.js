...
li{font-size:31px;font-weight:700;color:#F7E6F8;border:2px solid rgba(233,198,234,.5);border-radius:99px;padding:12px 26px;background:rgba(68,25,74,.5)}
...
</style><body><i class="g" style="width:960px;height:960px;left:-320px;top:-420px;background:rgba(243,88,238,.75)"></i><i class="g" style="width:700px;height:700px;right:-240px;bottom:-320px;background:rgba(117,255,66,.4)"></i><i class="g" style="width:44%;height:62%;left:40%;top:16%;background:rgba(215,129,9,.36)"></i><div class="pat"></div>
