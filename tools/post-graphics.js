...
.top span{font-size:21px;font-weight:700;letter-spacing:0;background:#F2B705;color:#111;border-radius:99px;padding:10px 20px}
.k{position:absolute;left:70px;top:176px;font-size:25px;font-weight:700;color:#74D6A4}
...
.foot{position:absolute;left:70px;right:70px;bottom:54px;display:flex;justify-content:space-between;font-size:23px;font-weight:500;color:#B9CFC3} .foot b{color:#fff;font-weight:700}
</style><body><i class="g" style="width:760px;height:760px;left:-260px;top:-320px;background:rgba(47,163,107,.75)"></i><i class="g" style="width:560px;height:560px;right:-200px;bottom:-260px;background:rgba(242,183,5,.42)"></i><div class="pat"></div>
